...
import OptionAddOns from './OptionAddOns';
      ...
      <div className='border rounded-lg'>
        <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
          ...
          >
            ...
            ${expanded === 'panel1' ? 'text-header-bg' : 'text-gray-500'}`}>Add On Wishcard</h3>
          </AccordionSummary>
          <AccordionDetails>
            <div className='grid grid-cols-2 gap-2'> 
            <div className='grid grid-rows-3 
              ml-4 gap-3 text-left font-sfPro 
        ...
        <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
          ...
          >
            <h3 className={`mx-3 font-sfPro text-[1.1rem] font-semibold 
            ${expanded === 'panel2' ? 'text-header-bg' : 'text-gray-500'}`}>Add On Box</h3>
          </AccordionSummary>
          <AccordionDetails>
            <div className='grid grid-cols-2 gap-2'> 
            <div className='grid grid-rows-3 
              ...
              <div className='grid grid-rows-3 ml-4 gap-3 font-sfPro font-semibold text-left'>
                <div>
        ...
        <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
          ...
          >
            <h3 className={`mx-3 font-sfPro text-[1.1rem] font-semibold 
            ${expanded === 'panel3' ? 'text-header-bg' : 'text-gray-500'}`}>Add On Wrapping</h3>
          </AccordionSummary>
          <AccordionDetails>
            <div className='grid grid-cols-2 gap-2'>
            <div className='grid grid-rows-3 
